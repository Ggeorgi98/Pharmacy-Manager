...
using PharmManager.Products.Repositories.Utils.Extensions;
using System.Linq.Expressions;

namespace PharmManager.Productss.Repositories
{
       ...
       where TDto : BaseDtoWithId
    {
        protected BaseCrudRepository(
            IDbContextFactory<ProductsContext> dBContext, IMapper mapper)
